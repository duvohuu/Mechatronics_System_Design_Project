    ...
    \subsection{Lựa chọn cảm biến màu sắc}
        ...
        \subsection{Lựa chọn mạch điều khiển động cơ}
            \subsubsection{Yêu cầu mạch điều khiển động cơ}
                ...
                \end{itemize}
            \subsubsection{So sánh các mạch điều khiển động cơ}
                \begin{table}[H]
                    \centering
                ...
                \end{table}
            \subsubsection{Kết luận}
                \hspace*{0.6cm}Sau khi phân tích các tiêu chí so sánh, nhóm quyết định sử dụng mạch TB6612 để điều khiển động cơ do đáp ứng được yêu cầu về kích thước nhỏ gọn, hiệu suất cao, tần số PWM lớn và độ chính xác cao trong điều khiển động cơ.
