...
const float KI_L = 15.5f;

// Store the Geometric parameters of the Robot
const uint16_t L_WHEEL = 200;
const uint16_t D_WHEEL = 50;
const uint16_t DIS_2_LineSen = 50;

// Desired velocity of robot
const uint16_t V_REF = 0.5f;


const float RADS_2_RPM = 9.55f;
const float RPM_2_RADS = 1.0f / RADS_2_RPM;

const float CONTROL_SAMP_TIME = 0.15f;	// PID line tracking controller sampling time
