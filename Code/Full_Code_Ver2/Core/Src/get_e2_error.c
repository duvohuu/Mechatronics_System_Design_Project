...
const uint16_t X_MAX[] = {3045, 3050, 3255, 3125, 3250};
const uint16_t X_MIN[] = {150, 145, 156, 162, 183};
volatile uint16_t ADCValues_AfterCalib[5] = {0, 0, 0, 0, 0};
float sum_ADCvalues = 0;

void calculate_sensor_value_aftercalib(uint16_t* adc_readout)
{
