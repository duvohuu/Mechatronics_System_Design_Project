...
// Variables for error line
volatile float prev_e2 = 0, curr_e2 = 0;
volatile float e2_buffer = 0;

// Variables count for PID line following controller
...
// Variables for PID line following controller
volatile float delta_w = 0;		// Output of PID line following controller (angular of robot)
volatile float pre_Dpart = 0;	// D part in PD controller

// Variables for decelaration phase
...
//				if (displacement <= 250 || (displacement >= 1450 && displacement <= 2900)){
//					if (minus_e2 >= 8.0 || curr_e2 >= 17.0){
//						recovery_mode = true;
//						outline_right = true;
...
//					}
//				}
				if (displacement <= 2900 && (curr_e2 >= 20.0)){
					recovery_mode = true;
					outline_right = true;
					turn_right_phase1 = true;
				}
				...
				else if (displacement >= 2930 && count_decelartion_2 != 21){
...
//
//
//		if (recovery_mode == true && outline_right == true){
//			if (turn_right_phase1 == true) {
//				w_right = (V_REF_TURN / (D_WHEEL / 2.0f)) + 3.5f;
//				w_left = (V_REF_TURN / (D_WHEEL / 2.0f)) - 1.5f;
//			}
...
//				count_turn_right_phase2++;
//			}
//			if (count_turn_right_phase2 == 65 || (data_buffer[2] > 3100 && abs_float(e2_buffer) < 8.0)){
//				recovery_mode = false;
//				outline_right = false;
//				outline = false;
//				turn_right_phase1 = false;
...
//
//
//		if (recovery_mode == true && outline_left == true){
//			if (turn_left_phase1 == true) {
//				w_left = (V_REF_TURN / (D_WHEEL / 2.0f)) + 3.5f;
//				w_right = (V_REF_TURN / (D_WHEEL / 2.0f)) - 1.5f;
//			}
...
//				count_turn_left_phase2++;
//			}
//			if ((count_turn_left_phase2 == 65 && (data_buffer[1] > 2500 || data_buffer[2] > 2500 || data_buffer[3] > 2500)) || (data_buffer[2] > 3100 && abs_float(e2_buffer) < 8.0)){
//				recovery_mode = false;
//				outline_left = false;
//				outline = false;
//				turn_left_phase1 = false;
